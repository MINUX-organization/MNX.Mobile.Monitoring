...
import com.minux.monitoring.feature.devices.impl.common.data.repository.DeviceRepositoryImpl
...
internal class DevicesModule {
    ...
    @Provides
    @Singleton
    fun provideDeviceRepository(wsClient: WsClient): DeviceRepository {
        return DeviceRepositoryImpl(
            devicesConnection = wsClient.createConnection(hub = BackendHub.Monitoring)
        )
    }
